    ...
    <div class="container marketing">
      <div class="container">   
		  ...
		  <div class="page-header">
		  	...
		  	<p class="load">Order Confirmation</p>
		  </div>
		  
		  
		  <div class="container">
		  	<div class="row">
		  		<form:form  class="form-forizaontal" commandName="order">
				  	<div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-md-offset-3">
